...
![hw_03](https://github.com/Qshar1408/hw_03/blob/main/img/hw_03_007.png)
...
![hw_03](https://github.com/Qshar1408/hw_03/blob/main/img/hw_03_010.png)
------
...
#### Когда значение nat = true

![hw_03](https://github.com/Qshar1408/hw_03/blob/main/img/hw_03_011.png)

#### Когда значение nat = false

![hw_03](https://github.com/Qshar1408/hw_03/blob/main/img/hw_03_012.png)
...
```
   ...
   * slice(local.vpc.subnet_ids, 0, 2) — берем элементы с индексами 0 и 1 (первые два)

   * slice(local.vpc.subnet_ids, 3, length(...)) — берем элементы с индекса 3 до конца (пропуская индекс 2)

   * concat(...) — объединяет эти две части, удаляя элемент с индексом 2.
